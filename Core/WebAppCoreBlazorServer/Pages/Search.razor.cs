    ...
    public partial class Search
    {
        ...
        protected override async Task OnInitializedAsync()
        {
            try
            {
                ...
                sw1.Stop();
                ErrorLog.WriteLog("Search/GetModule", sw1.ElapsedMilliseconds.ToString());
                ...
                sw2.Stop();
                ErrorLog.WriteLog("Search/GetDefCode", sw2.ElapsedMilliseconds.ToString());
                ...
                if (modSearch != null)
                {
                    ...
                    sw3.Stop();
                    ErrorLog.WriteLog("Search/Load Data Search", sw3.ElapsedMilliseconds.ToString());
                ...
                stopwatch.Stop();
                ErrorLog.WriteLog("Search/Index", stopwatch.ElapsedMilliseconds.ToString());
