namespace WebCore.Common
{
    ...
    public static class SYSTEM_STORE_PROCEDURES
    {
        ...
        public const string DEFTASKS_SELECT_ALL = "sp_DEFTASK_SELECT_ALL";
        public const string DEFMODWORKFLOW_SELECT_ALL = "MODWORKFLOW_SELECT_ALL";
        ...
        public const string LIST_FIELD_INFO_BY_MODID = "SP_DEFMODFLD_SEL_BY_MODID";
        public const string LIST_BUTTON_BY_MODID = "SP_DEFMODBTN_SEL_BY_MODID";
        public const string LIST_BUTTON_PARAM_BY_MODID = "SP_DEFMODBTNPARAM_SEL_BY_MODID";
        public const string LIST_LANGUAGE_BY_MODID = "SP_DEFLANG_SEL_BY_MODID";
        public const string LIST_STOREPROC_BY_MODID = "SP_STOREPROC_SEL_BY_MODID";
        ...
        public const string ModTreeView_SelectAll = "sp_Modtreeview_SelectAll";
