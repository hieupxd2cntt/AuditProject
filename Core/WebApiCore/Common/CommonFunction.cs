...
namespace WebApiCore
{
    public class CommonFunction
    {
        ...
        public void GetNpgsqlParameterValues(List<NpgsqlParameter> prrs, List<ModuleFieldInfo> fields)
        {
            //var fields = GetModuleFields();
            foreach (var param in prrs)
            {
                ...
                if (param.ParameterName.ToUpper() == "GUID")
                {
