...
namespace AppClient
{
    public partial class frmMainRibbonPOS
    {
        internal class frmMainRibbonPOSLanguage : IMainLanguage
        {
        ...
        internal frmMainRibbonPOSLanguage Language { get; set; }

        public void InitializeLanguage()
        {
            Language = new frmMainRibbonPOSLanguage
            {
