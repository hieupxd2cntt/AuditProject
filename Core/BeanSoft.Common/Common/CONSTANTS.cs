namespace Core.Common
{
    ...
    public static class SYSTEM_STORE_PROCEDURES
    {
        ...
        public const string LIST_DEFCODE = "SYSTEM_PROCS_SP_DEFCODE_SEL_ALL";
        public const string LIST_DEFERROR = "SYSTEM_PROCS_SP_DEFERROR_SEL_ALL";
        public const string LIST_DEFVALIDATE = "SYSTEM_PROCS_SP_DEFVALIDATE_SEL_ALL";
        public const string LIST_DEFLANG = "SYSTEM_PROCS_SP_DEFLANG_SEL_ALL";
        public const string LIST_DEFMENU = "SYSTEM_PROCS_SP_DEFMENU_SEL_ALL";
        public const string LIST_DEFRIBBON = "SYSTEM_PROCS_SP_DEFRIBBON_SEL_ALL";
        #endregion
        ...
        public const string LIST_TRANSACT_MODULE = "SYSTEM_PROCS_SP_DEFMOD_SEL_TRANSACT_ALL";
        #endregion
        ...
        #region TRANSATION
        public const string TRANS_STOREPROC = "SYSTEM_PROCS_SP_TLLOG_SEL";
        ...
        public const string MODULE_UNINSTALL = "SYSTEM_PROCS_SP_MODULE_UNINST";
        #endregion

        #region USER, GROUP, ROLE & SESSION
        public const string CREATE_NEW_SESSION = "SYSTEM_PROCS_SP_SESSIONS_CREATE";
        public const string UPDATE_SESSION_INFO = "SYSTEM_PROCS_SP_SESSIONS_UPDATE";
        public const string GET_SESSION_INFO = "SYSTEM_PROCS_SP_SESSIONS_SEL_BY_KEY";
        public const string TERMINAL_SESSION_INFO = "SYSTEM_PROCS_SP_SESSIONS_TERMINAL";
        public const string GET_SESSION_USER_INFO = "SYSTEM_PROCS_SP_USER_SEL_BY_USERNAME";
        public const string CHECK_USER_ROLE = "SYSTEM_PROCS_SP_USERROLE_CHECK";
        public const string LIST_USER_ROLE = "SYSTEM_PROCS_SP_DEFROLE_SEL_BY_USERID";
        public const string LIST_FUNCTION_USER_ROLE = "SYSTEM_PROCS_SP_DEFROLE_SESSIONUSERID";
        public const string LIST_GROUP_ROLE = "SYSTEM_PROCS_SP_DEFROLE_SEL_BY_GROUPID";
        public const string DELETE_GROUP_ROLE = "SYSTEM_PROCS_SP_GROUPROLE_DEL";
        public const string INSERT_GROUP_ROLE = "SYSTEM_PROCS_SP_GROUPROLE_INS";
        public const string DELETE_USER_ROLE = "SYSTEM_PROCS_SP_USERROLE_DEL";
        public const string INSERT_USER_ROLE = "SYSTEM_PROCS_SP_USERROLE_INS";
        public const string PROFILES_SEL = "SYSTEM_PROCS_SP_PROFILES_SEL";
        public const string GROUP_LIST_USERS = "SYSTEM_PROCS_SP_GROUP_LIST_USERS";
        public const string PROFILES_SEL_EXTRA = "SYSTEM_PROCS_SP_PROFILES_SEL_EXTRA";
        public const string PROFILES_UDP_EXTRA = "SYSTEM_PROCS_SP_PROFILES_UDP_EXTRA";
        public const string LIST_GROUP_SUMMARY_INFO = "SYSTEM_PROCS_SP_GROUPSUMMARY_SEL_ALL";
        public const string LIST_HEADER_EXPORT_INFO = "SYSTEM_PROCS_SP_EXPORTHEADER_SEL_ALL";
        public const string LIST_SYSVAR_INFO = "SYSTEM_PROCS_SP_SYSVAR_SEL_ALL";
        //add by TrungTT - 27.12.2012 - UserLog
        public const string USERSLOG_INSERT = "SYSTEM_PROCS_SP_USERSLOG_INS";
        //End TrungTT.
        //TuDQ them
        public const string GET_CHART_INF = "SYSTEM_PROCS_SP_GET_CHART_INF";
        //End 
        #endregion

        #region DEVELOPERS
        public const string GET_STATIC_MODULE = "DEVELOPER_PROCS_SP_DEFMOD_SEL_STATIC_BY_MODID";
        public const string GET_BATCH_MODULE = "DEVELOPER_PROCS_SP_DEFMOD_SEL_BATCH_BY_MODID";
        public const string GET_MAINTAIN_MODULE = "DEVELOPER_PROCS_SP_MODMAINTAIN_SEL_BY_MODID";
        public const string GET_REPORT_MODULE = "DEVELOPER_PROCS_SP_MODREPORT_SEL_BY_MODID";
        public const string GET_CHART_MODULE = "DEVELOPER_PROCS_SP_MODCHART_SEL_BY_MODID";
        public const string GET_SEARCHMASTER_MODULE = "DEVELOPER_PROCS_SP_MODSEARCH_SEL_BY_MODID";
        public const string GET_SWITCH_MODULE = "DEVELOPER_PROCS_SP_MODSWITCH_SEL_BY_MODID";
        public const string GET_IMPORT_MODULE = "DEVELOPER_PROCS_SP_MODIMPORT_SEL_BY_MODID";
        public const string GET_EXECUTEPROC_MODULE = "DEVELOPER_PROCS_SP_MODEXECPROC_SEL_BY_MODID";
        public const string GET_ALERT_MODULE = "DEVELOPER_PROCS_SP_MODALERT_SEL_BY_MODID";
        public const string GET_STATISTICS_MODULE = "DEVELOPER_PROCS_SP_MODSTATISTICS_SEL_BY_MODID";
        ...
        public const string UPDATE_DEFLANG = "DEVELOPER_PROCS_SP_DEFLANG_RPL";
        public const string MODULE_EXPORT = "DEVELOPER_PROCS_SP_MODULE_EXPORT";
        public const string GENERATE_PACKGE = "DEVELOPER_PROCS_SP_GENERATE_PACKAGE";
        public const string DEFROLE_UDP_PARENT = "DEVELOPER_PROCS_SP_DEFROLE_UDP_PARENT";
        public const string UPDATE_LAYOUT = "DEVELOPER_PROCS_SP_DEFLANG_UDP_LAYOUT";
        public const string SAVE_FILE = "KERNEL_PROCS_SP_FILE_INS";
        public const string GET_TREE_MODULE = "DEVELOPER_PROCS_SP_MODTREE_SEL_BY_MODID";
        public const string GET_EXPRESSION_MODULE = "DEVELOPER_PROCS_SP_MODEXP_SEL_BY_MODID";
        public const string GET_DASHBOARD_MODULE = "DEVELOPER_PROCS_SP_DASHBOARD_SEL_BY_MODID";
        public const string UPDATE_UBOUND_EXPRESSION = "DEVELOPER_PROCS_SP_DEFMODFLD_UPD_UBEXPRESSION";

        // Excel Template
        public const string EXCEL_TEMPLATE_INS = "PKG_TEMPLATE_SP_EXCELTEMPLATE_INS";
        public const string EXCEL_ELEMENTTEMPLATE_INS = "PKG_TEMPLATE_SP_EXCELTEMPELEMENT_INS";
        public const string REPORTBTNAME_INS = "PKG_EXCELREPORT_INS_REPORTBT_NAME";
        public const string UP_ROWFROMTO = "PKG_TEMPLATE_SP_UP_ROW_FROM_TO";
    ...
    public static class CONSTANTS
    {
        ...
        //End
        public const string PIC_EDIT_BOX_NAME_FORMAT = "peb{0}";
        public const string CALC_EDIT_BOX_NAME_FORMAT = "cal{0}";
        public const string RATING_NAME_FORMAT = "rate{0}";
        public const string TIME_EDIT_NAME_FORMAT = "time{0}";
        ...
        public const int POSTGRESQL_USER_HANDLED_EXCEPTION_CODE = 20000;
        ...
        public const string MAIN_COL_STT = "STT";
