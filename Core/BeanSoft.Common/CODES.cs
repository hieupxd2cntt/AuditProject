    ...
    namespace CODES
    {
        ...
        namespace DEFMOD
        {
            ...
            public static class MODTYPE
            {
                ...
                public const string TRANSACT = "15";
            ...
            public static class SUBMOD
            {
                ...
                public const string MAINTAIN_GRID_ADD = "MGA";
        ...
        namespace DEFMODFLD
        {
            ...
            public static class CTRLTYPE
            {
                ...
                public const string GRIDVIEWEXT = "GE";
                public const string RADIOGROUP = "RG";                
                public const string PICTUREBOX = "PB";
                public const string CALCEDITBOX = "CAL";
                public const string RATING = "RA";
                public const string TIMEEDIT = "TI";
                public const string TOGGLESWITCH = "TG";
            }
