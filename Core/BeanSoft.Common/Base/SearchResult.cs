...
namespace Core.Base
{
    public class SearchResult : IDisposable
    {
        ...
        private NpgsqlDataReader m_AdapDataReader;
        private NpgsqlDataReader m_AdapDataReader2;
        ...
        public NpgsqlDataReader DataReader {
            ...
            set
            {
                ...
                var field = typeof(NpgsqlDataReader).GetField("m_rowSize", BindingFlags.Instance | BindingFlags.NonPublic);
                if (field != null)
                {
                ...
                if (tblSchema != null)
                {
                    ...
                    {
                        CachedResult.Columns.Add(((string)rowSchema["ColumnName"]).ToUpper(), (Type)rowSchema["DataType"]);
                    }
                    if (m_AdapDataReader != null) IsBufferMode = false;
                }
            }
        }
        public NpgsqlDataReader DataReader2 {
            get
            {
