    ...
    public static class PostgresqlHelper
    {
        ...
        private static void AssignParameters(NpgsqlCommand comm, params object[] values)
        {
            try
            {
                ...
                {
                    if (param.NpgsqlDbType == NpgsqlDbType.Refcursor)
                    {
                        ...
                        else
                        {
                            switch (param.NpgsqlDbType)
                            {
                                ...
                                case NpgsqlDbType.Double:
                                    param.Value = Convert.ToDouble(values[index], App.Environment.ServerInfo.Culture);
                                    break;
                                default:
        ...
        public static void DiscoveryParameters(NpgsqlCommand comm)
        {
            try
            {
                ...
                if (m_CachedParameters.ContainsKey(cachedKey))
                {
                    ...
                    {
                        comm.Parameters.Add((NpgsqlParameter)param.Clone());
                    }
                }
                else
                {
                    ...
                    {
                        source[i] = (NpgsqlParameter)comm.Parameters[i].Clone();
                    }
        ...
        public static void ExecuteStoreProcedure(string connectionString, Session session, string commandText, params object[] values)
        {
            using (var conn = new NpgsqlConnection(connectionString))
            {
                ...
                try
                {
                    ...
                    NpgsqlDataReader pgreader = comm.ExecuteReader();
        ...
        //                       select
        //                           (param.Value as NpgsqlDataReader) ?? ((OracleRefCursor)param.Value).GetDataReader()).ToArray();
        ...
        public static Exception ThrowOracleUserException(NpgsqlException ex, string commandText)
        {
            if (ex.ErrorCode == CONSTANTS.ORACLE_USER_HANDLED_EXCEPTION_CODE)
            {
        ...
        //            var comm1 = new NpgsqlCommand(sqlQuery1, conn);
        //            comm1.CommandType = CommandType.StoredProcedure;
        //            var comm2 = new NpgsqlCommand(sqlQuery2, conn);
        //            var comm3 = new NpgsqlCommand(sqlQuery3, conn);
        //            var comm4 = new NpgsqlCommand(sqlQuery4, conn);
        //            comm4.CommandType = CommandType.StoredProcedure;
        //            comm4.Parameters.Add("CUR", NpgsqlDbType.RefCursor, ParameterDirection.Output);
        //            var comm5 = new NpgsqlCommand(sqlQuery5, conn);
        //            comm5.CommandType = CommandType.StoredProcedure;
        //            comm5.Parameters.Add("PV_REPORTID", NpgsqlDbType.Varchar2, ReportID, ParameterDirection.Input);
        //            comm5.Parameters.Add("CUR", NpgsqlDbType.RefCursor, ParameterDirection.Output);

        //            var comm6 = new NpgsqlCommand(sqlQuery6, conn);
        //            comm6.CommandType = CommandType.StoredProcedure;
        //            comm6.Parameters.Add("PV_REPORTID", NpgsqlDbType.Varchar2, ReportID, ParameterDirection.Input);
        //            comm6.Parameters.Add("CUR", NpgsqlDbType.RefCursor, ParameterDirection.Output);
        ...
        //            var adap = new NpgsqlDataAdapter(comm4);
        //            NpgsqlDataReader objReadercomm4 = comm4.ExecuteReader();
        ...
        //            //NpgsqlDataReader objReadercomm5_1 = comm5.ExecuteReader();
        ...
        //            NpgsqlDataReader objReadercomm5 = comm5.ExecuteReader();
